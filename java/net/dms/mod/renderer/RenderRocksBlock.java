...
public class RenderRocksBlock extends TileEntitySpecialRenderer {

	private static IModelCustom model;
	private static String textureName="Rocks";
	
	private ResourceLocation texture = new ResourceLocation(dms.modID+":textures/model/"+ textureName +".png");
	
	public RenderRocksBlock() {
		this.model = AdvancedModelLoader.loadModel(new ResourceLocation(dms.modID+":model/obj/Rocks.obj"));;
	}
