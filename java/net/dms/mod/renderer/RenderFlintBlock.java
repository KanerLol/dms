...
public class RenderFlintBlock extends TileEntitySpecialRenderer {

	private static IModelCustom model;
	private static String textureName="FLint";
	
	private ResourceLocation texture = new ResourceLocation(dms.modID+":textures/model/"+ textureName +".png");
	
	public RenderFlintBlock() {
		this.model = AdvancedModelLoader.loadModel(new ResourceLocation(dms.modID+":model/obj/Flint.obj"));;
	}
