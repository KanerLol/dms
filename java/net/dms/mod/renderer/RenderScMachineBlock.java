...
public class RenderScMachineBlock extends TileEntitySpecialRenderer {

	private static IModelCustom model;
	private static String textureName="scmachine";
	
	private ResourceLocation texture = new ResourceLocation(dms.modID+":textures/model/"+ textureName +".png");
	
	public RenderScMachineBlock() {
		this.model = AdvancedModelLoader.loadModel(new ResourceLocation(dms.modID+":model/obj/scmachine.obj"));;
	}
