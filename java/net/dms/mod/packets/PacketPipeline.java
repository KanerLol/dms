...
public class PacketPipeline extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket> {
    ...
    public void initialise() {
        this.channels = NetworkRegistry.INSTANCE.newChannel("dmspacketchannel", this);
        registerPackets();
    }
    ...
    public void registerPackets() {
    	...
    	registerPacket(SyncButtonGuiPot.class);
    	registerPacket(SyncButtonGuiPotOnOpen.class);
