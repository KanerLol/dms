...
public class RockBlock extends BlockContainer {
	...
	public void onBlockDestroyedByPlayer(World worldObj,int xCoord,int yCoord,int zCoord,int meta){
		if(!worldObj.isRemote){
    		worldObj.setBlock(xCoord, yCoord, zCoord, BlockDec.Rock1Block);
  
    	}
	}
	
	@Override
	public TileEntity createNewTileEntity(World arg0, int var2) {return new TileEntityRockBlock();}
